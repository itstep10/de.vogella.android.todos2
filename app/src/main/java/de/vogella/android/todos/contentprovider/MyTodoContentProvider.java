...
public class MyTodoContentProvider extends ContentProvider {
    ...
    private static final int MYTABLES = 30;
    private static final int MYTABLES_ID = 40;

    private static final String AUTHORITY = "de.vogella.android.todos.contentprovider";

    private static final String TODO_PATH = "todos";//private static final String BASE_PATH = "todos";
    private static final String MY_TABLE_PATH = "mytables";

    public static final Uri CONTENT_TODO_URI = Uri.parse("content://" + AUTHORITY + "/" + TODO_PATH); //public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + BASE_PATH);
    public static final Uri CONTENT_MY_TABLE_URI = Uri.parse("content://" + AUTHORITY + "/" + MY_TABLE_PATH);
    ...
    static {
        sURIMatcher.addURI(AUTHORITY, TODO_PATH, TODOS);
        sURIMatcher.addURI(AUTHORITY, TODO_PATH + "/#", TODO_ID);
        sURIMatcher.addURI(AUTHORITY, MY_TABLE_PATH, MYTABLES);
        sURIMatcher.addURI(AUTHORITY, MY_TABLE_PATH + "/#", MYTABLES_ID);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (uriType) {
            ...
            case TODO_ID:
                ...
                break;
            case MYTABLES:
                queryBuilder.setTables(MyTable.MY_TABLE);
                break;
            case MYTABLES_ID:
                queryBuilder.setTables(MyTable.MY_TABLE);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriType) {
            case TODOS:
                ...
                break;
            case MYTABLES:
                id = sqlDB.insert(MyTable.MY_TABLE, "name", values);
                break;
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
        }
        ...
        switch (uriType) {
            ...
            case MYTABLES:
                return Uri.parse(MY_TABLE_PATH + "/" + id);
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
        }
    }
